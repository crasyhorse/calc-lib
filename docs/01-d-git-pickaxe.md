...
4. Wechsle in den Branch `main`. Zeige nun die letzten beiden Commits des Autors *JohnDoe*, die `src/add.ts` verändert haben, als Oneliner. *Tipp:* Google nach einer Option, die nach dem Autor filtern kann.
